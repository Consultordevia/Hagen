...
Page 50180 "Mis Clientes"
{
    ...
    SourceTableView = where("Estatus del cliente"=const(Activo));
    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                field("Estatus del cliente";"Estatus del cliente")
                {
                    ApplicationArea = Basic;
                }
            }
        ...
        area(navigation)
        {
            group("&Customer")
            {
                ...
                action("Clientes Lista")
                {
                    ...
                    PromotedIsBig = true;
                    PromotedOnly = true;
                    RunObject = Page UnknownPage50078;
                }
                action("Co&mments")
                {
                    ApplicationArea = Basic;
    ...
    begin
        ...
        if UserSetup."Salespers./Purch. Code"<>'' then begin
            ...
            SetFilter("Mas comerciales",'*'+UserSetup."Salespers./Purch. Code"+'*');
        end;
