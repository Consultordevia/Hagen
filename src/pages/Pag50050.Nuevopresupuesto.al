...
Page 50050 "Nuevo presupuesto"
{
    ...
    /*
        layout
        {
            area(content)
            {
                ...
                /////-
                part(SalesLines;Rec."Lineas presupuesto")
                {
                    ApplicationArea = Basic,Suite;
            ...
            area(factboxes)
            {
                /* /////-part(Control1000000029;Rec."Item Picture")
                {
                    ApplicationArea = Advanced;
                    Provider = SalesLines;
                ...
                part(Control1000000018;Rec."Sales Line FactBox")
                {
                    ApplicationArea = Suite;
                    Provider = SalesLines;
                ...
                part(Control1000000004;Rec."Ofertas combinadas")
                {
                ...
                part(Control1000000022;Rec."Sales Hist. Sell-to FactBox")
                {
                    ApplicationArea = Advanced;
                    SubPageLink = "No."=field("Sell-to Customer No.");
                }
                part(Control1000000023;Rec."Sales Hist. Bill-to FactBox")
                {
                    ApplicationArea = Advanced;
                ...
                part(Control1903433807;Rec."Cartera Receiv. Statistics FB")
                {
                    ApplicationArea = Basic,Suite;
                    SubPageLink = "No."=field("Bill-to Customer No.");
                    Visible = true;
                }
                part(Control1903433607;Rec."Cartera Fact. Statistics FB")
                {
                    ApplicationArea = Basic,Suite;
                    SubPageLink = "No."=field("Bill-to Customer No.");
                    Visible = true;
                }
                part(IncomingDocAttachFactBox;Rec."Incoming Doc. Attach. FactBox")
                {
                    ApplicationArea = Advanced;
                    ShowFilter = false;
                    Visible = false;
                }
                part(Control11;Rec."Pending Approval FactBox")
                {
                    ApplicationArea = All;
                ...
                part(Control1902018507;Rec."Customer Statistics FactBox")
                {
                    ApplicationArea = Advanced;
                    SubPageLink = "No."=field("Bill-to Customer No.");
                    Visible = false;
                }
                part(Control1900316107;Rec."Customer Details FactBox")
                {
                    ApplicationArea = Advanced;
                    SubPageLink = "No."=field("Sell-to Customer No.");
                    Visible = false;
                }
                part(Control1901314507;Rec."Item Invoicing FactBox")
                {
                    ApplicationArea = Advanced;
                    Provider = SalesLines;
                    SubPageLink = "No."=field("No.");
                ...
                part(ApprovalFactBox;Rec."Approval FactBox")
                {
                    ApplicationArea = Advanced;
                    Visible = false;
                }
                part(Control1907012907;Rec."Resource Details FactBox")
                {
                    ApplicationArea = Advanced;
                    Provider = SalesLines;
                    SubPageLink = "No."=field("No.");
                ...
                part(WorkflowStatus;Rec."Workflow Status FactBox")
                {
                    ApplicationArea = All;
                    Editable = false;
                    Enabled = false;
        ...
        var
            ...
            Item2: Record Item;
            Conseguido: Text;
            Multitabla2: Record UnknownRecord50020;
        ...
        begin
            ...
            Rec362.Insert(true);
            ////CODACTI:=Rec362."No.";
            Rec362."Shipping No. Series":="Shipping No. Series";
                 ...
                 if Rec372.FindFirst then repeat
                      ...
                      if RecProd.Get(Rec372."No.") then begin
                           ...
                           if (not RecProd."No permite pedido") and (RecProd."Producto con reserva") then begin
                                RecClie.Get("Sell-to Customer No.");
                                if RecClie."No."<>'4703' then begin
                                     RecMT2.Reset;
                                     RecMT2.SetRange(RecMT2.Tabla,1);
                                     RecMT2.SetRange(RecMT2."Código 1",Rec372."No.");
                                     RecMT2.SetRange(RecMT2."Código 2",RecClie."Grupo clientes");
            ...
            if "Fecha envio pendiente stock"<>0D then begin
                 ...
                 if Rec372.FindFirst then repeat
                      ...
                      if RecProd.Get(Rec372."No.") then begin
                           ...
                           if ("Fecha envio pendiente stock">fecha2) and (not RecProd."Producto con reserva") then begin
                                Rec37.Init;
                                Rec37:=Rec372;
                                Rec37."Document Type":=1;
                                Rec37."Document No.":=CODACTI;
                           ...
                           if ("Fecha envio pendiente stock">fecha2) and (RecProd."Producto con reserva") then begin
                           Message('2  %1 ',Rec372);
                                RecClie.Get("Sell-to Customer No.");
                                RecMT2.Reset;
                                RecMT2.SetRange(RecMT2.Tabla,1);
            ...
            RecLC1.Reset;
            RecLC1.SetRange(RecLC1."Document Type","Document Type");
            RecLC1.SetRange(RecLC1."No.","No.");
            if RecLC1.FindFirst then repeat
    ...
    */
    ...
    /*
            ...
            Multitabla2.SetRange(Multitabla2."Código 1","Sell-to Customer No.");
            ...
            if Multitabla2.FindLast then begin
                 ...
                 if CustomerDiscountGroup.Get(Multitabla2."Código 2") then begin
                      Conseguido:=Multitabla2."Código 2"+' '+CustomerDiscountGroup.Description+' supera: '+Format(Multitabla2."Importe minimo para descuento");
                      Importenuevodto:=ImporteTarifa-ROUND(ImporteTarifa*Multitabla2."Descuento a aplicar"/100,0.01);     end;
        ...
        begin
            ...
            Rec."Customer Disc. Group":=Multitabla2."Código 2";
            Rec.Modify;
