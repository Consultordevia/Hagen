...
Page 50025 Demanda
{
    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                field("Unidad de compra";"Unidad de compra")
                {
                    ApplicationArea = Basic;
                    StyleExpr = color;
                }
                ...
                field("Dispo.actual";"Dispo.actual")
                {
                    ApplicationArea = Basic;
                    StyleExpr = color;
                }
                field("Dispo.futura";"Dispo.futura")
                {
                    ApplicationArea = Basic;
                    StyleExpr = color;
                }
                ...
                field(Clasificacion;Clasificacion)
                {
                    ApplicationArea = Basic;
                    StyleExpr = color;
                }
                field("Cantidad en presupuestos";"Cantidad en presupuestos")
                {
                    ApplicationArea = Basic;
                }
                field(Total;Total)
                ...
                field("Media dia de ult. x meses";"Media dia de ult. x meses")
                {
                    ApplicationArea = Basic;
                    StyleExpr = color;
                }
                ...
                field("Para dias stock";"Para dias stock")
                {
                    ApplicationArea = Basic;
                    StyleExpr = color;
                }
                ...
                field("Dias rearov.";"Dias rearov.")
                {
                    ApplicationArea = Basic;
                    StyleExpr = color;
                }
                field(Contenedor;Contenedor)
                {
                    ApplicationArea = Basic;
                    StyleExpr = color;
                }
                ...
                field("Fecha oferta 1";"Fecha oferta 1")
                {
                    ApplicationArea = Basic;
                    Editable = false;
                }
                field("Pedido oferta 1";"Pedido oferta 1")
                {
                    ApplicationArea = Basic;
                    Editable = false;
                }
                field("Fecha oferta 2";"Fecha oferta 2")
                {
                    ApplicationArea = Basic;
                    Editable = false;
                }
                field("Pedido oferta 2";"Pedido oferta 2")
                {
                    ApplicationArea = Basic;
                    Editable = false;
                }
                field("Fecha oferta 3";"Fecha oferta 3")
                {
                    ApplicationArea = Basic;
                    Editable = false;
                }
                field("Pedido oferta 3";"Pedido oferta 3")
                {
                    ApplicationArea = Basic;
                    Editable = false;
                }
                field("Fecha oferta 4";"Fecha oferta 4")
                {
                    ApplicationArea = Basic;
                    Editable = false;
                }
                field("Pedido oferta 4";"Pedido oferta 4")
                {
                    ApplicationArea = Basic;
                    Editable = false;
                }
                field("Fecha contenedor 1";"Fecha contenedor 1")
                {
                    ApplicationArea = Basic;
                    Editable = false;
                }
                field("Pedido contenedor 1";"Pedido contenedor 1")
                {
                    ApplicationArea = Basic;
                    Editable = false;
                }
                field("Fecha contenedor 2";"Fecha contenedor 2")
                {
                    ApplicationArea = Basic;
                    Editable = false;
                }
                field("Pedido contenedor 2";"Pedido contenedor 2")
                {
                    ApplicationArea = Basic;
                    Editable = false;
                }
                field("Stock Futuro";"Stock Futuro")
                {
                    ApplicationArea = Basic;
                    StyleExpr = color;
                }
                field("Para dias futuro";"Para dias futuro")
                {
                    ApplicationArea = Basic;
                    StyleExpr = color;
                }
                field("Cantidad master";"Cantidad master")
                {
                    ApplicationArea = Basic;
                    StyleExpr = color;
                }
                field(Propuesta;Propuesta)
                {
                    ApplicationArea = Basic;
                    StyleExpr = color;
                }
                field("Para dias propuesta";"Para dias propuesta")
                {
                    ApplicationArea = Basic;
                    StyleExpr = color;
                }
                field("Tot.disp.mes";"Tot.disp.mes")
                {
                    ApplicationArea = Basic;
                    StyleExpr = color;
                }
                field("Tot.disp.fut.";"Tot.disp.fut.")
                {
                    ApplicationArea = Basic;
                    StyleExpr = color;
                }
                ...
                field("Sin stock";"Sin stock")
                {
                    ApplicationArea = Basic;
                    StyleExpr = color;
                }
                field("Meses media";"Meses media")
                {
                    ApplicationArea = Basic;
                    StyleExpr = color;
                }
                field("Canridad en pedidos venta";"Canridad en pedidos venta")
                {
                    ApplicationArea = Basic;
                    DecimalPlaces = 0:0;
                }
                field("Intervalo-12";"Intervalo-12")
                {
                    ApplicationArea = Basic;
                    DecimalPlaces = 0:0;
                    StyleExpr = color;
                }
                field("Presupuesto-12";"Presupuesto-12")
                {
                    ApplicationArea = Basic;
                    DecimalPlaces = 0:0;
                    StyleExpr = color;
                }
                field("Intervalo-11";"Intervalo-11")
                {
                    ApplicationArea = Basic;
                    DecimalPlaces = 0:0;
                    StyleExpr = color;
                }
                field("Presupuesto-11";"Presupuesto-11")
                {
                    ApplicationArea = Basic;
                    DecimalPlaces = 0:0;
                    StyleExpr = color;
                }
                field("Intervalo-10";"Intervalo-10")
                {
                    ApplicationArea = Basic;
                    DecimalPlaces = 0:0;
                    StyleExpr = color;
                }
                field("Presupuesto-10";"Presupuesto-10")
                {
                    ApplicationArea = Basic;
                    DecimalPlaces = 0:0;
                    StyleExpr = color;
                }
                field("Intervalo-9";"Intervalo-9")
                {
                    ApplicationArea = Basic;
                    DecimalPlaces = 0:0;
                    StyleExpr = color;
                }
                field("Presupuesto-9";"Presupuesto-9")
                {
                    ApplicationArea = Basic;
                    DecimalPlaces = 0:0;
                    StyleExpr = color;
                }
                field("Intervalo-8";"Intervalo-8")
                {
                    ApplicationArea = Basic;
                    DecimalPlaces = 0:0;
                    StyleExpr = color;
                }
                field("Presupuesto-8";"Presupuesto-8")
                {
                    ApplicationArea = Basic;
                    DecimalPlaces = 0:0;
                    StyleExpr = color;
                }
                field("Intervalo-7";"Intervalo-7")
                {
                    ApplicationArea = Basic;
                    DecimalPlaces = 0:0;
                    StyleExpr = color;
                }
                field("Presupuesto-7";"Presupuesto-7")
                {
                    ApplicationArea = Basic;
                    DecimalPlaces = 0:0;
                    StyleExpr = color;
                }
                field("Intervalo-6";"Intervalo-6")
                {
                    ApplicationArea = Basic;
                    DecimalPlaces = 0:0;
                    StyleExpr = color;
                }
                field("Presupuesto-6";"Presupuesto-6")
                {
                    ApplicationArea = Basic;
                    DecimalPlaces = 0:0;
                    StyleExpr = color;
                }
                field("Intervalo-5";"Intervalo-5")
                {
                    ApplicationArea = Basic;
                    DecimalPlaces = 0:0;
                    StyleExpr = color;
                }
                field("Presupuesto-5";"Presupuesto-5")
                {
                    ApplicationArea = Basic;
                    DecimalPlaces = 0:0;
                    StyleExpr = color;
                }
                field("Intervalo-4";"Intervalo-4")
                {
                    ApplicationArea = Basic;
                    DecimalPlaces = 0:0;
                    StyleExpr = color;
                }
                field("Presupuesto-4";"Presupuesto-4")
                {
                    ApplicationArea = Basic;
                    DecimalPlaces = 0:0;
                    StyleExpr = color;
                }
                field("Intervalo-3";"Intervalo-3")
                {
                    ApplicationArea = Basic;
                    DecimalPlaces = 0:0;
                    StyleExpr = color;
                }
                field("Presupuesto-3";"Presupuesto-3")
                {
                    ApplicationArea = Basic;
                    DecimalPlaces = 0:0;
                    StyleExpr = color;
                }
                field("Intervalo-2";"Intervalo-2")
                {
                    ApplicationArea = Basic;
                    DecimalPlaces = 0:0;
                    StyleExpr = color;
                }
                field("Presupuesto-2";"Presupuesto-2")
                {
                    ApplicationArea = Basic;
                    DecimalPlaces = 0:0;
                    StyleExpr = color;
                }
                field("Intervalo-1";"Intervalo-1")
                {
                    ApplicationArea = Basic;
                    DecimalPlaces = 0:0;
                    StyleExpr = color;
                }
                field("Presupuesto-1";"Presupuesto-1")
                {
                    ApplicationArea = Basic;
                    DecimalPlaces = 0:0;
                    StyleExpr = color;
                ...
                field("Observaciones AMAZON";"Observaciones AMAZON")
                {
                    ApplicationArea = Basic;
                }
                */
    ...
    begin
        ...
        if RequisitionLine.FindFirst then repeat
        ...
        if Item.FindFirst then repeat
             ...
             repeat
                  ...
                  if SalesLine22.FindFirst then repeat
             ...
             if RecLC.FindFirst then repeat
                  if RecLC."Outstanding Quantity"<>0 then begin
                       nofer:=nofer+1;
                       /////-cCONTENEDOR:=Contenedor+RecLC."Outstanding Quantity";
