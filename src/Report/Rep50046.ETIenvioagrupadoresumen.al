...
{	
	...
	{
		type(ForNav.Report_7_3_0_2521; ForNavReport50046_v7_3_0_2521){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream50046){}   
		type("System.IO.Path"; System_IO_Path50046) {}
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 50046 "ETI. envio agrupado resumen"
{
	UseRequestPage = false;
	RDLCLayout = './Layouts/ETI.envioagrupadoresumen.rdlc'; DefaultLayout = RDLC;
	...
	dataset
	{
		dataitem("Sales Header";"Sales Header")
		{
			...
			column(SalesHeaderNoexpedicion___SalesHeaderNoexpedicionagrupada; "Sales Header"."Nº expedición")
			{
			}
			...
			begin
				...
				TipocajaG.Reset;
				if TipocajaG.FindFirst then repeat
				...
				SalesHeader.SetRange("Nº expedición","Sales Header"."Nº expedición");
					...
					if not Multitabla2.FindFirst then begin
						...
						if SalesLineTC.FindFirst then repeat
							if Item.Get(SalesLineTC."No.") then begin
							  if Item."Producto almacenable" then begin
				...
				textocaja1:=CopyStr(textocaja,1,40);
				textocaja2:=CopyStr(textocaja,41,40);
				textocaja3:=CopyStr(textocaja,81,40);
					 ...
					 if Rec37.FindFirst then repeat
						  if (Rec37."No."<>'TRAN') and (Rec37."No."<>'REM') then begin
							   if Rec37."Outstanding Quantity"<>0 then begin
									...
									if NLIN=4 then obs2:=obs2+Format(Rec37."No.")+'='+Format(Rec37."Outstanding Qty. (Base)")+' // ';
	...
	var
		...
		Item: Record Item;
		textocaja: Text;
		Tipocaja: Record UnknownRecord50026;
		SalesHeader: Record "Sales Header";
		NCAJAS: Decimal;
		textocaja1: Text;
		textocaja2: Text;
		textocaja3: Text;
		TipocajaG: Record UnknownRecord50026;
		Multitabla2: Record UnknownRecord50031;
		cajas7: Integer;
		cajas8: Integer;
		cajas9: Integer;
		cajas10: Integer;
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport50046_v7_3_0_2521;
	...
	var
		...
		path: DotNet System_IO_Path50046;
