...
{	
	...
	{
		type(ForNav.Report_7_3_0_2521; ForNavReport50028_v7_3_0_2521){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream50028){}   
		type("System.IO.Path"; System_IO_Path50028) {}
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 50028 "Albaran de venta valorado"
{
	Caption = 'Sales - Invoice';
	Permissions = TableData "Sales Shipment Buffer"=rimd;
	RDLCLayout = './Layouts/Albarandeventavalorado.rdlc'; DefaultLayout = RDLC;
				...
				dataitem(PageLoop;Integer)
				{
					...
					dataitem("Sales Shipment Line";"Sales Shipment Line")
					{
						...
						begin
							...
							totaluni:=totaluni+"Sales Shipment Line".Quantity;
	...
	begin
		with Table111 do begin
		  ReportForNav.ShowOutput((VALORADO=true) and (DETALLEPVP=false));
		end;
	end;
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport50028_v7_3_0_2521;
	...
	var
		...
		path: DotNet System_IO_Path50028;
