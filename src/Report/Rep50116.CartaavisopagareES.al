...
Report 50116 "Carta aviso pagare-ES"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Carta aviso pagare-ES.rdlc';
    Caption = 'Carta aviso pagare-ES';
    ...
    dataset
    {
        dataitem(Customer;Customer)
        {
            ...
            dataitem("Cust. Ledger Entry";"Cust. Ledger Entry")
            {
                ...
                DataItemTableView = sorting("Customer No.","Posting Date") where("Payment Method Code"=const('PAGARE'),Open=const(true));
    ...
    begin
        ...
        texto4:='información a continuación y nos informen si los pagarés han sido enviados.';
        texto5:='';
        texto6:='Santander: ES5200491021192110275678';
        texto7:='BBVA: ES5001820529200201575004';
        texto8:='Cajamar: ES4430582275911021004521';
        texto9:='';
        ...
        texto19:='Si al recibir este comunicado, ya hubiesen enviado el pagaré,';
