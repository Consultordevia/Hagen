...
Report 50107 "Carta aviso transfarencias PT"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Carta aviso transfarencias PT.rdlc';
    ...
    begin
        ...
        texto2 := 'Apresente serve para detalhar as próximas faturas que estão prestes';
        texto3 := 'a expirar. Por favor, reveja as informações abaixo e faça as transferências';
        texto4 := 'bancárias correspondentes no vencimento. Facilitamos-lhe as nossas contas';
        texto5 := 'de débito para que possa escolher para que entidade pretende transferir:';
        texto6 := '';
        texto7 := 'Santander: ES5200491021192110275678';
        texto8 := 'BBVA: ES5001820529200201575004';
        texto9 := 'Cajamar: ES4430582275911021004521';

        texto10 := 'Também gostaríamos de informá-lhe que, por comodidade, pode alterar o seu';
        texto12 := 'método de pagamento para conta de débito. É totalmente gratuito e não terá';
        ...
        texto16 := 'Se deseja modificar o seu método de pagamento, contate-nos por';
        texto17 := 'e-mail a: administracion1@hagen.es, ou ligando para os nosso escritório';
        texto18 := 'onde o ajudaremos no departamento de administração.';

        texto19 := 'Se, após a receção desta comunicação, já tiverem emitido a transferência';
        texto20 := 'bancária, Pedimos desculpa pelo inconveniente.Caso tenha alguma dúvida ';
        texto21 := 'ou sugestão, não hesite em contactar-nos.';
