...
Report 50052 "ETI. envio agrupado ka"
{
    UseRequestPage = false;
    RDLCLayout = './Layouts/ETI.envioagrupadoka.rdlc';
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            DataItemTableView = sorting("Nº expedición agrupada");
            ...
            column(SalesHeaderNoexpedicion___SalesHeaderNoexpedicionagrupada; "Sales Header"."Nº expedición" + '  -  ' +
             "Sales Header"."Nº expedición dropshp" + ' /B:' + Format(bultos))
            ...
            column(nexpiagrupada; "Sales Header"."Nº expedición agrupada")
            {
            }
