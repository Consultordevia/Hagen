...
{	
	...
	{
		type(ForNav.Report_7_3_0_2521; ForNavReport50041_v7_3_0_2521){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream50041){}   
		type("System.IO.Path"; System_IO_Path50041) {}
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 50041 "Pedido HAGEN"
{
	Caption = 'Pedido HAGEN';
	RDLCLayout = './Layouts/PedidoHAGEN.rdlc'; DefaultLayout = RDLC;
	...
	dataset
	{
		dataitem("Sales Header";"Sales Header")
		{
			...
			dataitem("Sales Line";"Sales Line")
			{
				...
				column(totalbase_SalesLinePmtDiscGivenAmount; totalbase+"Sales Line"."Pmt. Disc. Given Amount")
				{
					AutoFormatExpression = "Sales Header"."Currency Code";
					AutoFormatType = 1;
				}
				column(PmtDiscGivenAmount_SalesLine; -"Sales Line"."Pmt. Disc. Given Amount")
				{
					AutoFormatExpression = "Sales Header"."Currency Code";
					AutoFormatType = 1;
				}
				...
				column(TotalPEDIDO; 'Total PEDIDO')
				{
				}
				...
				begin
					...
					totalbase:=totalbase+("Sales Line"."Line Amount"-"Sales Line"."Pmt. Disc. Given Amount");
					totaliva:=totaliva+ROUND(("Sales Line"."Line Amount"-"Sales Line"."Pmt. Disc. Given Amount")
					*("Sales Line"."VAT %"+"Sales Line"."EC %"),0.01)/100;
					totalfac:=totaliva+("Sales Line"."Line Amount"-"Sales Line"."Pmt. Disc. Given Amount")+
					+ROUND(("Sales Line".Amount-"Sales Line"."Pmt. Disc. Given Amount")*"Sales Line"."VAT %",0.01)/100;
	...
	local procedure OnPreSectionSalesLine_Header2(var "Sales Line" : Record "Sales Line");
	begin
		with "Sales Line" do begin
		  ReportForNav.ShowOutput(GetCarteraInvoice);
		end;
	end;
	local procedure OnPreSectionSalesLine_Header3(var "Sales Line" : Record "Sales Line");
	begin
		with "Sales Line" do begin
		  ReportForNav.ShowOutput(VALORADO);
		end;
	end;
	local procedure OnPreSectionSalesLine_Header4(var "Sales Line" : Record "Sales Line");
	begin
		with "Sales Line" do begin
		  ReportForNav.ShowOutput(not VALORADO);
		end;
	end;
	local procedure OnPreSectionSalesLine_Body6(var "Sales Line" : Record "Sales Line");
	begin
		with "Sales Line" do begin
	...
	begin
		with "Sales Line" do begin
		  ReportForNav.ShowOutput("Sales Line"."Description 2"<>'');
		end;
	end;
	local procedure OnPreSectionSalesLine_Body8(var "Sales Line" : Record "Sales Line");
	begin
		with "Sales Line" do begin
		  ReportForNav.ShowOutput((Type > 0) and (VALORADO) and (not FRAGIL));
		end;
	end;
	local procedure OnPreSectionSalesLine_Body9(var "Sales Line" : Record "Sales Line");
	begin
		with "Sales Line" do begin
		  ReportForNav.ShowOutput((Type > 0) and (VALORADO) and FRAGIL);
		end;
	end;
	local procedure OnPreSectionSalesLine_Body10(var "Sales Line" : Record "Sales Line");
	begin
		with "Sales Line" do begin
		  ReportForNav.ShowOutput((Type > 0) and (not VALORADO) and (not FRAGIL));
		end;
	end;
	local procedure OnPreSectionSalesLine_Body11(var "Sales Line" : Record "Sales Line");
	begin
		with "Sales Line" do begin
		  ReportForNav.ShowOutput((Type > 0) and (not VALORADO) and FRAGIL);
		end;
	end;
	local procedure OnPreSectionSalesLine_Footer16(var "Sales Line" : Record "Sales Line");
	begin
		with "Sales Line" do begin
		  ReportForNav.ShowOutput((not "Sales Header"."Prices Including VAT") and (VALORADO));
		end;
	end;
	local procedure OnPreSectionSalesLine_Footer18(var "Sales Line" : Record "Sales Line");
	begin
		with "Sales Line" do begin
	...
	local procedure OnPreSectionSalesLine_Footer19(var "Sales Line" : Record "Sales Line");
	begin
		with "Sales Line" do begin
		  ReportForNav.ShowOutput("Sales Header"."Prices Including VAT" and
		  (VATAmountLine."VAT Calculation Type" = VATAmountLine."vat calculation type"::"Reverse Charge VAT"));
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport50041_v7_3_0_2521;
	...
	var
		...
		path: DotNet System_IO_Path50041;
