...
{	
	...
	{
		type(ForNav.Report_7_3_0_2521; ForNavReport50070_v7_3_0_2521){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream50070){}   
		type("System.IO.Path"; System_IO_Path50070) {}
	}
...
{
	Caption = 'Work Order';
	RDLCLayout = './Layouts/EtiquetaBUITRAGO.rdlc'; DefaultLayout = RDLC;
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport50070_v7_3_0_2521;
	...
	var
		...
		path: DotNet System_IO_Path50070;
