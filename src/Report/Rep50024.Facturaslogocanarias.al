...
{	
	...
	{
		type(ForNav.Report_7_3_0_2521; ForNavReport50024_v7_3_0_2521){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream50024){}   
		type("System.IO.Path"; System_IO_Path50024) {}
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 50024 "Facturas logo canarias"
{
	Caption = 'Facturas logo';
	Permissions = TableData "Sales Shipment Buffer"=rimd;
	RDLCLayout = './Layouts/Facturaslogocanarias.rdlc'; DefaultLayout = RDLC;
	...
	dataset
	{
		dataitem("Sales Invoice Header";"Sales Invoice Header")
		{
			...
			column(TelEspana__34961200945; 'Tel.España: +34 96 120 09 45')
			{
			}
			...
			dataitem(CopyLoop;Integer)
			{
				...
				dataitem(PageLoop;Integer)
				{
					...
					dataitem(DimensionLoop1;Integer)
					{
						...
						column(ReportForNavId_49; 49) {} // Autogenerated by ForNav - Do not delete
					...
					dataitem("Sales Invoice Line";"Sales Invoice Line")
					{
						...
						column(CIFJ766488152; 'CIF. J76648815')
						{
						}
						column(TelEspana__349612009452; 'Tel.España: +34 96 120 09 45')
						{
						}
			...
			begin
				if Exists('\\192.168.0.225\compartido\CABECERA.BMP') then begin
					 "Sales Invoice Header"."Logo cabecera".Import('\\192.168.0.225\compartido\CABECERA.BMP',false);
				end;
				DETALLEPVP:=false;
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport50024_v7_3_0_2521;
	...
	var
		...
		path: DotNet System_IO_Path50024;
