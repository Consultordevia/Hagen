...
{	
	...
	{
		type(ForNav.Report_7_3_0_2521; ForNavReport50030_v7_3_0_2521){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream50030){}   
		type("System.IO.Path"; System_IO_Path50030) {}
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 50030 "Albaran sin detalle"
{
	Caption = 'Albaran sin detalle';
	Permissions = TableData "Sales Shipment Buffer"=rimd;
	RDLCLayout = './Layouts/Albaransindetalle.rdlc'; DefaultLayout = RDLC;
		...
		dataitem("Sales Shipment Header";"Sales Shipment Header")
		{
			...
			dataitem(CopyLoop;Integer)
			{
				...
				dataitem(PageLoop;Integer)
				{
					...
					{
						DataItemTableView = sorting(Number) where(Number=const(1));
						column(ReportForNavId_57; 57) {} // Autogenerated by ForNav - Do not delete
	...
	local procedure OnPreSectionTable111_Footer17(var "Sales Shipment Line" : Record "Sales Shipment Line");
	begin
		with Table111 do begin
		  ReportForNav.ShowOutput("Sales Shipment Header"."Prices Including VAT" and
		  (VATAmountLine."VAT Calculation Type" = VATAmountLine."vat calculation type"::"Reverse Charge VAT"));
	...
	local procedure OnPreSectionTotal2_Body25(var Total2 : Record Integer);
	begin
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport50030_v7_3_0_2521;
	...
	var
		...
		path: DotNet System_IO_Path50030;
