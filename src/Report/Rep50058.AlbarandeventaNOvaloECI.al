...
{	
	...
	{
		type(ForNav.Report_7_3_0_2521; ForNavReport50058_v7_3_0_2521){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream50058){}   
		type("System.IO.Path"; System_IO_Path50058) {}
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 50058 "Albaran de venta NO valo ECI"
{
	Caption = 'Albaran de venta valorado ECI';
	Permissions = TableData "Sales Shipment Buffer"=rimd;
	RDLCLayout = './Layouts/AlbarandeventaNOvaloECI.rdlc'; DefaultLayout = RDLC;
		...
		dataitem("Sales Shipment Header";"Sales Shipment Header")
		{
			...
			dataitem(CopyLoop;Integer)
			{
				...
				dataitem(PageLoop;Integer)
				{
					...
					column(TotalBultos__FORMAT_TBULTOSECI_; 'Total Bultos: '+Format(TBULTOSECI))
					{
					}
			...
			begin
				...
				*/
				...
				TBULTOSECI:=0;
				REC372.RESET;
				REC372.SETRANGE(REC372."Document No.","Sales Shipment Header"."No.");
	...
	var
		...
		REC372: Record "Sales Shipment Line";
		TBULTOSECI: Integer;
		tlinea: Decimal;
		CODIGO: Code[80];
		codebar: Code[23];
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport50058_v7_3_0_2521;
	...
	var
		...
		path: DotNet System_IO_Path50058;
