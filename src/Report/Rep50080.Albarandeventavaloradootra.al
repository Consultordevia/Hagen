...
{	
	...
	{
		type(ForNav.Report_7_3_0_2521; ForNavReport50080_v7_3_0_2521){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream50080){}   
		type("System.IO.Path"; System_IO_Path50080) {}
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 50080 "Albaran de venta valorado-otra"
{
	Caption = 'Sales - Invoice';
	Permissions = TableData "Sales Shipment Buffer"=rimd;
	RDLCLayout = './Layouts/Albarandeventavalorado-otra.rdlc'; DefaultLayout = RDLC;
			...
			dataitem(CopyLoop;Integer)
			{
				...
				dataitem(PageLoop;Integer)
				{
					...
					dataitem("Sales Shipment Line";"Sales Shipment Line")
					{
						...
						column(VATAmountLineCalculatedECAmount; VATAmountLine."Calculated EC Amount")
						{
						}
	...
	local procedure OnPreSectionTable111_Footer19(var "Sales Shipment Line" : Record "Sales Shipment Line");
	begin
		with Table111 do begin
	...
	local procedure OnPreSectionTable111_Footer22(var "Sales Shipment Line" : Record "Sales Shipment Line");
	begin
		with Table111 do begin
		  ReportForNav.ShowOutput("Sales Shipment Header"."Prices Including VAT" and
		  (VATAmountLine."VAT Calculation Type" = VATAmountLine."vat calculation type"::"Reverse Charge VAT"));
	...
	local procedure OnPreSectionVATCounter_Header25(var VATCounter : Record Integer);
	begin
		with VATCounter do begin
		  ReportForNav.ShowOutput(VALORADO);
		end;
	end;
	local procedure OnPreSectionVATCounter_Body27(var VATCounter : Record Integer);
	begin
		with VATCounter do begin
		  ReportForNav.ShowOutput(VALORADO);
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport50080_v7_3_0_2521;
	...
	var
		...
		path: DotNet System_IO_Path50080;
