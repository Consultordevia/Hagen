...
{	
	...
	{
		type(ForNav.Report_7_3_0_2521; ForNavReport56772_v7_3_0_2521){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream56772){}   
		type("System.IO.Path"; System_IO_Path56772) {}
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 56772 "_Descuento abonos venta.22322"
{
	RDLCLayout = './Layouts/_Descuentoabonosventa.22322.rdlc'; DefaultLayout = RDLC;
				...
				begin
					if YaDescontado then
					  ...
					  if DescontarAbono(MovCli) then begin
						...
						Doc:=Next_doc.GetNextNo(nserie,Today,true);
						MCtemp.Reset;
	...
	var
		...
		NEFEC: Code[10];
		Next_doc: Codeunit NoSeriesManagement;
		nserie: Code[10];
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport56772_v7_3_0_2521;
	...
	var
		...
		path: DotNet System_IO_Path56772;
