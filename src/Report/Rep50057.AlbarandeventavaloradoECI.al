...
{	
	...
	{
		type(ForNav.Report_7_3_0_2521; ForNavReport50057_v7_3_0_2521){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream50057){}   
		type("System.IO.Path"; System_IO_Path50057) {}
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 50057 "Albaran de venta valorado ECI"
{
	Caption = 'Albaran de venta valorado ECI';
	Permissions = TableData "Sales Shipment Buffer"=rimd;
	RDLCLayout = './Layouts/AlbarandeventavaloradoECI.rdlc'; DefaultLayout = RDLC;
		...
		dataitem("Sales Shipment Header";"Sales Shipment Header")
		{
			...
			dataitem(CopyLoop;Integer)
			{
				...
				dataitem(PageLoop;Integer)
				{
					...
					column(TotalBultos__FORMAT_TBULTOS_; 'Total Bultos: '+Format(TBULTOS))
					{
					}
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport50057_v7_3_0_2521;
	...
	var
		...
		path: DotNet System_IO_Path50057;
