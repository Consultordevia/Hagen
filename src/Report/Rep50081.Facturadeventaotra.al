...
{	
	...
	{
		type(ForNav.Report_7_3_0_2521; ForNavReport50081_v7_3_0_2521){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream50081){}   
		type("System.IO.Path"; System_IO_Path50081) {}
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 50081 "Factura de venta-otra"
{
	Caption = 'Sales - Invoice';
	Permissions = TableData "Sales Shipment Buffer"=rimd;
	RDLCLayout = './Layouts/Facturadeventa-otra.rdlc'; DefaultLayout = RDLC;
			...
			dataitem(CopyLoop;Integer)
			{
				...
				dataitem(PageLoop;Integer)
				{
					...
					dataitem("Sales Invoice Line";"Sales Invoice Line")
					{
						...
						column(ReportForNavId_62; 62) {} // Autogenerated by ForNav - Do not delete
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport50081_v7_3_0_2521;
	...
	var
		...
		path: DotNet System_IO_Path50081;
