...
{	
	...
	{
		type(ForNav.Report_7_3_0_2521; ForNavReport50056_v7_3_0_2521){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream50056){}   
		type("System.IO.Path"; System_IO_Path50056) {}
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 50056 "Factura de venta Portugal"
{
	Caption = 'Factura de venta Portugal';
	Permissions = TableData "Sales Shipment Buffer"=rimd;
	RDLCLayout = './Layouts/FacturadeventaPortugal.rdlc'; DefaultLayout = RDLC;
	...
	dataset
	{
		dataitem("Sales Invoice Header";"Sales Invoice Header")
		{
			...
			column(TotalIVA23Pct; 'Total I.V.A.23%.')
			{
			}
			...
			dataitem(CopyLoop;Integer)
			{
				...
				dataitem(PageLoop;Integer)
				{
					...
					dataitem("Sales Invoice Line";"Sales Invoice Line")
					{
						...
						column(LineAmount4; "Sales Invoice Line"."Line Amount")
						{
						...
						begin
							...
							basef:=basef+Amount;
							///ivaf:=ivaf+round(Amount*23/100,0.01);
							///totalf:=totalf+round(Amount*23/100,0.01)+Amount;
			...
			begin
				...
				if RecDDP.FindFirst then repeat
					 /////textodiaspago:=textodiaspago+' '+FORMAT(RecDDP."Payment Day")
				until RecDDP.Next=0;
	...
	var
		...
		Table112: Record "Sales Invoice Header";
	...
	local procedure OnPreSectionTable112_Footer1(var "Sales Invoice Header" : Record "Sales Invoice Header");
	begin
		with Table112 do begin
		  ivaf:=ROUND(basef*23/100,0.01);
		  totalf:=basef+ROUND(basef*23/100,0.01);
		end;
	end;
	...
	local procedure OnPreSectionTable113_Footer12(var "Sales Invoice Line" : Record "Sales Invoice Line");
	begin
		with Table113 do begin
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport50056_v7_3_0_2521;
	...
	var
		...
		path: DotNet System_IO_Path50056;
