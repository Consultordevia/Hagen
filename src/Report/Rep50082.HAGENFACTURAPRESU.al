...
{	
	...
	{
		type(ForNav.Report_7_3_0_2521; ForNavReport50082_v7_3_0_2521){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream50082){}   
		type("System.IO.Path"; System_IO_Path50082) {}
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 50082 "HAGEN FACTURA PRESU"
{
	Caption = 'Presupuesto HAGEN PDF';
	RDLCLayout = './Layouts/HAGENFACTURAPRESU.rdlc'; DefaultLayout = RDLC;
	...
	dataset
	{
		dataitem("Sales Header";"Sales Header")
		{
			...
			column(CIF__CompanyInfoVATRegistrationNo; 'CIF: '+CompanyInfo."VAT Registration No.")
			{
			}
			column(CIF__CustVATRegistrationNo; 'CIF: '+Cust."VAT Registration No.")
			{
			}
			...
			column(Logocabecera_SalesHeader; "Logo cabecera")
			{
				AutoCalcField = true;
			}
			dataitem("Sales Line";"Sales Line")
			{
				...
				begin
					if ("Sales Line".Type=2) and ("Sales Line".Quantity=0) then begin
						 CurrReport.Skip;
					end;
					if not todo then begin
						 if not "Sales Line"."Permite pedido" then begin
							  CurrReport.Skip;
						 end;
					end;
					Renglon:=Renglon+1;
	...
	local procedure OnPreSectionSalesLine_Footer15(var "Sales Line" : Record "Sales Line");
	begin
		with "Sales Line" do begin
		  ReportForNav.ShowOutput((not "Sales Header"."Prices Including VAT") and (VALORADO));
		end;
	end;
	local procedure OnPreSectionSalesLine_Footer17(var "Sales Line" : Record "Sales Line");
	begin
		with "Sales Line" do begin
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport50082_v7_3_0_2521;
	...
	var
		...
		path: DotNet System_IO_Path50082;
