...
{	
	...
	{
		type(ForNav.Report_7_3_0_2521; ForNavReport50090_v7_3_0_2521){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream50090){}   
		type("System.IO.Path"; System_IO_Path50090) {}
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 50090 "Notificación contable pdf"
{
	UseRequestPage = false;
	RDLCLayout = './Layouts/Notificacióncontablepdf.rdlc'; DefaultLayout = RDLC;
	...
	dataset
	{
		dataitem("Gen. Journal Line";"Gen. Journal Line")
		{
			...
			column(GenJournalLineLogocabecera; "Gen. Journal Line"."Logo cabecera")
			{
			}
			...
			begin
				if Exists('\\192.168.0.225\compartido\CABECERA.BMP') then begin
					 "Gen. Journal Line"."Logo cabecera".Import('\\192.168.0.225\compartido\CABECERA.BMP',false);
				end;
				for i := 1 to 8
				do DirClie[i]:='';
				Clie.Init;
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport50090_v7_3_0_2521;
	...
	var
		...
		path: DotNet System_IO_Path50090;
