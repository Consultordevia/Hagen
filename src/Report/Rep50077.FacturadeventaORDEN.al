...
{	
	...
	{
		type(ForNav.Report_7_3_0_2521; ForNavReport50077_v7_3_0_2521){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream50077){}   
		type("System.IO.Path"; System_IO_Path50077) {}
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 50077 "Factura de venta ORDEN"
{
	Caption = 'Factura de venta ORDEN';
	Permissions = TableData "Sales Shipment Buffer"=rimd;
	RDLCLayout = './Layouts/FacturadeventaORDEN.rdlc'; DefaultLayout = RDLC;
		...
		dataitem("Sales Invoice Header";"Sales Invoice Header")
		{
			...
			dataitem(CopyLoop;Integer)
			{
				...
				dataitem(PageLoop;Integer)
				{
					...
					column(Departamentoproveedores_primeraplanta; 'Departamento proveedores, primera planta')
					{
					}
					...
					dataitem("Sales Invoice Line";"Sales Invoice Line")
					{
						...
						column(ReportForNavId_63; 63) {} // Autogenerated by ForNav - Do not delete
					...
					{
						DataItemTableView = sorting(Number) where(Number=const(1));
						column(ReportForNavId_115; 115) {} // Autogenerated by ForNav - Do not delete
					}
	...
	begin
		with Table113 do begin
		  ReportForNav.ShowOutput((Type > 0) and  (DETALLEPVP=false));
		end;
	end;
	local procedure OnPreSectionTable113_Body12(var "Sales Invoice Line" : Record "Sales Invoice Line");
	begin
		with Table113 do begin
		  ReportForNav.ShowOutput((Type > 0) and  (DETALLEPVP=true));
		end;
	end;
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport50077_v7_3_0_2521;
	...
	var
		...
		path: DotNet System_IO_Path50077;
