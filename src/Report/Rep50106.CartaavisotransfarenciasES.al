...
Report 50106 "Carta aviso transfarencias ES"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Carta aviso transfarencias ES.rdlc';
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            dataitem("Cust. Ledger Entry"; "Cust. Ledger Entry")
            {
                ...
                DataItemTableView = sorting("Customer No.", "Posting Date") where("Payment Method Code" = const('TRANSFEREN'), Open = const(true));
    ...
    begin
        ...
        texto2 := 'Nos dirigimos a ustedes mediante la presente, para detallarles';
        texto3 := 'las próximas facturas que están a punto de vencer. Rogamos revisen la';
        texto4 := 'información a continuación y realicen las correspondientes transferencias';
        texto5 := 'bancarias al vencimiento. Les indicamos nuestras cuentas corrientes para';
        texto6 := 'que puedan elegir a qué entidad desean realizar la transferencia:';
        texto7 := 'Santander: ES5200491021192110275678';
        texto8 := 'BBVA: ES5001820529200201575004';
        texto9 := 'Cajamar: ES4430582275911021004521';
        texto10 := 'Asimismo, queremos informarles que, para mayor comodidad, pueden cambiar ';
        texto12 := 'su método de pago a domiciliación bancaria. Es totalmente gratuita y no se';
        texto13 := 'tendrán que preocupar de la emisión de transferencias o pagarés. Solamente se';
        texto14 := 'requiere el IBAN de su cuenta, información que está totalmente protegida por';
        texto15 := 'nuestra política de protección de datos.';
        texto16 := 'Si desean domiciliar sus pagos, por favor pónganse en contacto con nosotros a';
        texto17 := 'través del e-mail administracion1@hagen.es, o bien llamando a nuestras oficinas';
        texto18 := 'donde le atenderemos en el departamento de administración.';

        texto19 := 'Si al recibir este comunicado, ya hubiesen emitido la transferencia bancaria,';
        texto20 := 'rogamos disculpen las molestias.';
