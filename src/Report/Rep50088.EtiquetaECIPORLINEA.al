...
{	
	...
	{
		type(ForNav.Report_7_3_0_2521; ForNavReport50088_v7_3_0_2521){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream50088){}   
		type("System.IO.Path"; System_IO_Path50088) {}
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 50088 "Etiqueta ECI POR LINEA"
{
	Caption = 'Etiqueta ECI POR LINEA';
	RDLCLayout = './Layouts/EtiquetaECIPORLINEA.rdlc'; DefaultLayout = RDLC;
		...
		dataitem("Sales Header";"Sales Header")
		{
			...
			dataitem("Sales Line";"Sales Line")
			{
				...
				begin
					...
					PROD1.Get('10');
					PROD1.Picture.Import(rut+'a.bmp');
					...
					PROD3.Get('10');
					PROD3.Picture.Import(rut+'c.bmp');
						 NUMETIQ:=0;
						 CONTAETI:=0;
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport50088_v7_3_0_2521;
	...
	var
		...
		path: DotNet System_IO_Path50088;
