...
Report 50917 "OK Albaran El mosca"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/OK Albaran El mosca.rdlc';
    Caption = 'OK Albaran El mosca';
    ...
    dataset
    {
        dataitem("Sales Shipment Header";"Sales Shipment Header")
        {
            ...
            column(agencia;"Sales Shipment Header"."Shipping Agent Code")
            {
            }
            dataitem(CopyLoop;"Integer")
            {
                ...
                dataitem(PageLoop;"Integer")
                {
                    ...
                    column(Palets;"Sales Shipment Header"."Nº Palets")
                    {
                    }
                    column(Peso;"Sales Shipment Header"."Total peso")
                    {
                    }
                    column(TotalBulto;"Sales Shipment Header"."Nº bultos")
                    {
                    }
                    column(YourReference;"Sales Shipment Header"."Your Reference")
                    {
                    }
                    column(Telefono;Customer."Phone No."+'  '+"Sales Shipment Header"."Envio a-Nº Telefono"+'   '+"Sales Shipment Header"."E-MAIL")
                    {
                    }
                    ...
                    dataitem("Sales Shipment Line";"Sales Shipment Line")
                    {
                        ...
                        column(importe_SalesinvoiceLine;importe)
                        {
                        }
                        column(pvprecomendado;pvprecomendado)
                        {
                        }
                        ...
                        begin
                            ...
                            if "Sales Shipment Line".Quantity<>0 then begin
                              importe:=neto*"Sales Shipment Line".Quantity;
