...
Report 50103 "Albaran valorado estandar"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Albaran valorado estandar.rdlc';
        ...
        dataitem("Sales Shipment Header";"Sales Shipment Header")
        {
            ...
            dataitem(CopyLoop;"Integer")
            {
                ...
                dataitem(PageLoop;"Integer")
                {
                    ...
                    column(CompanyInfoPhoneNo;'ALBARAN VALORADO')
                    {
                    }
                    column(ShipToAddr6;ShipToAddr[6])
                    {
                    }
                    column(CompanyInfoHomePage;'ALBARAN VALORADO')
                    {
                    }
                    column(CompanyInfoEmail;'ALBARAN VALORADO')
                    {
                    }
                    column(CompanyInfoFaxNo;'ALBARAN VALORADO')
                    {
                    }
                    column(CompanyInfoVATRegtnNo;'ALBARAN VALORADO')
                    {
                    }
