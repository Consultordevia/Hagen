                ...
                dataitem(PageLoop;"Integer")
                {
                    ...
                    dataitem(RoundLoop;"Integer")
                    {
                        ...
                        begin
                            ...
                            ItemCrossReference.SetRange(ItemCrossReference."Cross-Reference No.","Purchase Line"."No.");
                            ItemCrossReference.SetRange(ItemCrossReference."Cross-Reference Type",ItemCrossReference."cross-reference type"::Vendor);
                            ItemCrossReference.SetRange(ItemCrossReference."Cross-Reference Type No.","Purchase Line"."Buy-from Vendor No.");
