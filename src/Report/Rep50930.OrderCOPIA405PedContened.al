...
Report 50930 "Order COPIA 405 - Ped Contened"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Order COPIA 405 - Ped Contened.rdlc';
    Caption = 'Order';
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem(RoundLoop; "Integer")
                    {
                        ...
                        column(Cantidadpalets; Item."Cantidad palets")
                        {
                        }
                        column(Cantidadinner; cantiIN)
                        {
                        }
                        column(Cantidadmaster; cantiMa)
                        {
                        }
                        column(DescripcionLarga; WorkDescription)
                        {
                        }
                        ...
                        begin
                            ...
                            /////-if ("Purchase Line".cros ."Reference No." <> '') and (not ShowInternalInfo)then
                            /////-"Purchase Line"."No." := "Purchase Line"."Reference No.";
                            ...
                            if Item.Get("Purchase Line"."No.") then begin
                                ...
                                cantiMa := 0;
                                cantiIN := 0;
                                if ItemUnitofMeasure.Get("Purchase Line"."No.", 'MA') then begin
                                    cantiMa := ItemUnitofMeasure."Qty. per Unit of Measure";
                                end;
                                if ItemUnitofMeasure.Get("Purchase Line"."No.", 'IN') then begin
                                    cantiIN := ItemUnitofMeasure."Qty. per Unit of Measure";
                                end;
                            end;
                            ...
                            ItemCrossReference.SetRange(ItemCrossReference."Reference No.", "Purchase Line"."No.");
                            ItemCrossReference.SetRange(ItemCrossReference."Reference Type", ItemCrossReference."reference type"::Vendor);
                            ItemCrossReference.SetRange(ItemCrossReference."Reference Type No.", "Purchase Line"."Buy-from Vendor No.");
                            if ItemCrossReference.FindFirst then begin
                                /////-WorkDescription := ItemCrossReference.GetWorkDescription;
                            end;
                        end;
            ...
            trigger OnAfterGetRecord()
            begin
                /////_CurrReport.Language := Language.GetLanguageID("Language Code");
