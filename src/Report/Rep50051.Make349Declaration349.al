...
Report 50051 "_Make 349 Declaration 349"
{
    ...
    dataset
    {
        dataitem("Integer";"Integer")
        {
            ...
            begin
                ...
                /// 0A,01,02,03,04,05,06,07,08,09,10,11,12,1T,2T,3T,4T
                case Period of
                  0:
                    begin
    ...
    begin
        ...
        if (DESDEFECHA<>0D) and (HASTAFECHA<>0D) then begin
             FromDate := DESDEFECHA;
             ToDate := HASTAFECHA;
        end;
    end;
