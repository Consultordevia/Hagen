...
{	
	...
	{
		type(ForNav.Report_7_3_0_2521; ForNavReport50062_v7_3_0_2521){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream50062){}   
		type("System.IO.Path"; System_IO_Path50062) {}
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 50062 "Etiqueta ECI NUEVA ALBARAN3"
{
	Caption = 'Etiqueta ECI NUEVA';
	RDLCLayout = './Layouts/EtiquetaECINUEVAALBARAN3.rdlc'; DefaultLayout = RDLC;
		...
		dataitem("Sales Header";"Sales Shipment Header")
		{
			...
			dataitem("Sales Line";"Sales Shipment Line")
			{
				...
				begin
					...
					/////00319739740010215350{14{285{200{c:\c.bmp
					rut:='\\192.168.0.252\a_gestion\ini\';
					ok:= SHELL('C:\navibar2\Navibar.exe',dcentro+'{14{185{200{'+rut+'a.bmp');
					prod1.Get('10');
					/////prod1.Picture.IMPORT(rut+'a.bmp');
					ok:= SHELL('C:\navibar2\Navibar.exe',CODBAR+'{14{285{200{'+rut+'b.bmp');
					prod2.Get('10');
					/////prod2.Picture.IMPORT(rut+'+b.bmp');
					ok:= SHELL('C:\navibar2\Navibar.exe',nueva+'{14{300{200{'+rut+'c.bmp');
					prod3.Get('10');
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport50062_v7_3_0_2521;
	...
	var
		...
		path: DotNet System_IO_Path50062;
