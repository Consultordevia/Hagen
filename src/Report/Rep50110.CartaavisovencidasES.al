...
Report 50110 "Carta aviso vencidas ES"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Carta aviso vencidas ES.rdlc';
    Caption = 'Carta aviso transfarencias';
    ...
    begin
        ...
        texto1:='Apreciado cliente,';
        texto2:='Nos dirigimos a ustedes mediante la presente, para detallarles las facturas';
        texto3:='que nos aparecen vencidas. Rogamos revisen la información a continuación y realicen las';
        texto4:='correspondientes transferencias bancarias lo antes posible. Les indicamos nuestras cuentas';
        texto5:='corrientes para que puedan elegir a qué entidad desean realizar la transferencia:';
        texto6:='';
        texto7:='Santander: ES5200491021192110275678';
        texto8:='BBVA: ES5001820529200201575004';
        texto9:='Cajamar: ES4430582275911021004521';
        texto10:='Por favor tengan en cuenta que el sistema ha bloqueado su cuenta de cliente y por lo tanto sus';
        texto12:='pedidos no podrán ser procesados hasta que las facturas vencidas sean pagadas.';

        texto13:='Asimismo, queremos informarles que, para mayor comodidad, pueden cambiar su método de';
        texto14:='pago a domiciliación bancaria. Es totalmente gratuita y no se tendrán que preocupar de la';
        texto15:='emisión de transferencias o pagarés. Solamente se requiere el IBAN de su cuenta, información';
        texto16:='que está totalmente protegida por nuestra política de protección de datos.';
        texto17:='Si desean domiciliar sus pagos por favor pónganse en contacto nosotros a través del e-mail';
        texto18:='administracion1@hagen.es, o bien llamando a nuestras oficinas donde le atenderemos en el';
        texto19:='departamento de administración.';

        texto20:='Si al recibir este comunicado, ya hubiesen realizado el pago, rogamos disculpen las molestias.';
        texto21:='En caso de que tuvieran alguna duda o sugerencia por favor no duden en contactarnos.';
        texto22:='Agradecemos de antemano su colaboración.';

        texto23:='Saludos cordiales,';
