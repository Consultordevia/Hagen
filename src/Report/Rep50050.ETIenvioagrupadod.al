...
{	
	...
	{
		type(ForNav.Report_7_3_0_2521; ForNavReport50050_v7_3_0_2521){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream50050){}   
		type("System.IO.Path"; System_IO_Path50050) {}
	}
...
Report 50050 "ETI. envio agrupado d"
{
	...
	RDLCLayout = './Layouts/ETI.envioagrupadod.rdlc'; DefaultLayout = RDLC;
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport50050_v7_3_0_2521;
	...
	var
		...
		path: DotNet System_IO_Path50050;
