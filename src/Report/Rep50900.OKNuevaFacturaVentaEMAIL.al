...
Report 50900 "OK Nueva Factura Venta EMAIL"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/OK Nueva Factura Venta EMAIL.rdlc';
    Caption = 'OK Nueva Factura Venta EMAIL';
    ...
    dataset
    {
        dataitem("Sales Invoice Header";"Sales Invoice Header")
        {
            ...
            column(CustComentariofactura;Cust."Comentario factura")
            {
            }
                ...
                dataitem(PageLoop;"Integer")
                {
                    ...
                    dataitem("Sales Invoice Line";"Sales Invoice Line")
                    {
                        ...
                        begin
                            ...
                            NETO:=0;
                            if "Sales Invoice Line".Quantity<>0 then begin
                                 NETO:="Sales Invoice Line".Amount/"Sales Invoice Line".Quantity;
                            end;
            ...
            begin
                ...
                if Customer.Get("Sales Invoice Header"."Sell-to Customer No.") then begin
                    if Customer."Contacto en factura"=false then begin
                ...
                if SalesInvoiceLineB.FindFirst then repeat
