...
{	
	...
	{
		type(ForNav.Report_7_3_0_2521; ForNavReport50105_v7_3_0_2521){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream50105){}   
		type("System.IO.Path"; System_IO_Path50105) {}
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 50105 "Etiqueta ECI NUEVA ALB."
{
	Caption = 'Etiqueta ECI NUEVA ALB.';
	RDLCLayout = './Layouts/EtiquetaECINUEVAALB..rdlc'; DefaultLayout = RDLC;
		...
		dataitem("Sales Header";"Sales Shipment Header")
		{
			...
			dataitem("Sales Line";"Sales Shipment Line")
			{
				...
				dataitem(Integer;Integer)
				{
					...
					column(CANTI; sumacantidad)
					{
					}
					column(NALBA; NALBA)
					{
					}
					column(NBUL___FORMAT_SUNABUL; Format(NUMETIQ)+' / '+Format(NUMETIQ2))
					{
					}
			...
			begin
				...
				if REC371.Quantity<>0 then begin
					 ...
					 /////sumacantidad:=sumacantidad+REC371.Quantity;
				end;
				until REC371.Next=0;
			end;
	...
	begin
		...
		Pasadatos(NUMETIQ,NUMETIQ2,codssc);

		sumacantidad:=0;
		Cajasporenvio.Reset;
		Cajasporenvio.SetRange(SSCC,codssc);
		Cajasporenvio.SetRange("Caja num",NUMETIQ);
		...
		codssc:=CopyStr(codssc,1,4)+CopyStr(codssc,6,4)+CopyStr(codssc,11,4)+CopyStr(codssc,16,4)+CopyStr(codssc,21,4);
	...
	procedure Pasadatos(Num: Integer;Cuan: Integer;cdcccc: Text)
	begin
		NUMETIQ2:=Cuan;
		NUMETIQ:=Num;
		codssc:=cdcccc;
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport50105_v7_3_0_2521;
	...
	var
		...
		path: DotNet System_IO_Path50105;
