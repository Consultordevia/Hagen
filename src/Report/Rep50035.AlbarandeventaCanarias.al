...
{	
	...
	{
		type(ForNav.Report_7_3_0_2521; ForNavReport50035_v7_3_0_2521){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream50035){}   
		type("System.IO.Path"; System_IO_Path50035) {}
	}
...
Report 50035 "Albaran de venta Canarias"
{
	...
	RDLCLayout = './Layouts/AlbarandeventaCanarias.rdlc'; DefaultLayout = RDLC;
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport50035_v7_3_0_2521;
	...
	var
		...
		path: DotNet System_IO_Path50035;
