...
{	
	...
	{
		type(ForNav.Report_7_3_0_2521; ForNavReport50026_v7_3_0_2521){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream50026){}   
		type("System.IO.Path"; System_IO_Path50026) {}
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 50026 "ETI. ECI"
{
	UseRequestPage = false;
	RDLCLayout = './Layouts/ETI.ECI.rdlc'; DefaultLayout = RDLC;

	dataset
	{
		dataitem("Extended Text Header";"Extended Text Header")
		{
			DataItemTableView = sorting("Table Name","No.","Language Code","Text No.") where("Table Name"=const(EtiquetasECI));
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport50026_v7_3_0_2521;
	...
	var
		...
		path: DotNet System_IO_Path50026;
