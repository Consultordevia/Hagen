...
{	
	...
	{
		type(ForNav.Report_7_3_0_2521; ForNavReport50031_v7_3_0_2521){}   
	}
	assembly("mscorlib")
	{
		Version='4.0.0.0';
		type("System.IO.Stream"; SystemIOStream50031){}   
		type("System.IO.Path"; System_IO_Path50031) {}
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 50031 "Facturas logo"
{
	Caption = 'Facturas logo';
	Permissions = TableData "Sales Shipment Buffer"=rimd;
	RDLCLayout = './Layouts/Facturaslogo.rdlc'; DefaultLayout = RDLC;
		...
		dataitem("Sales Invoice Header";"Sales Invoice Header")
		{
			...
			dataitem(CopyLoop;Integer)
			{
				...
				dataitem(PageLoop;Integer)
				{
					...
					column(SalesInvoiceHeaderLogocabecera; "Sales Invoice Header"."Logo cabecera")
					{
					}
					...
					dataitem(DimensionLoop1;Integer)
					{
						...
						column(ReportForNavId_50; 50) {} // Autogenerated by ForNav - Do not delete
					...
					dataitem("Sales Invoice Line";"Sales Invoice Line")
					{
						...
						column(ReportForNavId_52; 52) {} // Autogenerated by ForNav - Do not delete
						...
						column(CIF_CompanyInfoVATRegistrationNo2; 'CIF. '+CompanyInfo."VAT Registration No.")
						{
						}
						column(TelEspana__34961200945TelPortugal__3513088034002; 'Tel.España: +34 96 120 09 45  Tel.Portugal: +351 308 803 400')
						{
						}
	...
	local procedure OnPreSectionVATCounter_Body25(var VATCounter : Record Integer);
	begin
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport50031_v7_3_0_2521;
	...
	var
		...
		path: DotNet System_IO_Path50031;
