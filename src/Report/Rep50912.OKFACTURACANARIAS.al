...
Report 50912 "OK FACTURA CANARIAS"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/OK FACTURA CANARIAS.rdlc';
    Caption = 'OK Albaran Valorado';
            ...
            dataitem(CopyLoop;"Integer")
            {
                ...
                dataitem(PageLoop;"Integer")
                {
                    ...
                    dataitem("Sales Shipment Line";"Sales Shipment Line")
                    {
                        ...
                        column(base;"Sales Shipment Header".Base)
                        {
                        }
                        column(base2;"Sales Shipment Line"."Qty. Invoiced (Base)")
                        {
                        }
