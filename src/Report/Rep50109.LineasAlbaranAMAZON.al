...
Report 50109 "Lineas Albaran AMAZON"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Lineas Albaran AMAZON.rdlc';
    ...
    dataset
    {
        dataitem("Sales Shipment Line";"Sales Shipment Line")
        {
            ...
            column(EAN;Item."Ref. AMAZON")
            {
            }
            column(EAN2;"Sales Shipment Line"."cod ean")
            {
            }
            ...
            column(SalesHeaderASN;SalesHeader.ASN)
            {
            }
            column(SalesHeaderPalets;SalesHeader."Nº Palets")
            {
            }
            ...
            begin
                ...
                ncajas:=0;
                CajasAMAZON.Reset;
                CajasAMAZON.SetRange("Nº Expedicion","Sales Shipment Line"."Nº expedición");
                if CajasAMAZON.FindFirst then repeat
                ...
                SalesHeader.Get("Sales Shipment Line"."Document No.");
                ...
                Amazonmaster_inner.SetRange(Amazonmaster_inner."Item No.","Sales Shipment Line"."No.");
                if Amazonmaster_inner.FindFirst then begin
                    "Sales Shipment Line"."Cantidad inner":=Amazonmaster_inner."Cantidad inner";
                    "Sales Shipment Line"."Cantidad master":=Amazonmaster_inner."Cantidad master";
                end;


                if "Sales Shipment Line".Type="Sales Shipment Line".Type::Item then begin
                    TotalLineas:=TotalLineas+1;
                    TotalCantidad:=TotalCantidad+"Sales Shipment Line".Quantity;
                    if "Sales Shipment Line"."Cantidad master"<>0 then begin
                        Q_Masters:=ROUND("Sales Shipment Line".Quantity/"Sales Shipment Line"."Cantidad master",1,'<');
                        if Q_Masters*"Sales Shipment Line"."Cantidad master"<>"Sales Shipment Line".Quantity then begin
                            Resto_inner:="Sales Shipment Line".Quantity-(Q_Masters*"Sales Shipment Line"."Cantidad master");
                        end;
                    end;
                    if (Resto_inner>="Sales Shipment Line"."Cantidad inner") and ("Sales Shipment Line"."Cantidad inner"<>1) then begin
                        if Resto_inner<>0 then begin
                            if "Sales Shipment Line"."Cantidad inner"<>0 then begin
                                Q_Inners:=ROUND(Resto_inner/"Sales Shipment Line"."Cantidad inner",1,'<');
                                if (Q_Masters*"Sales Shipment Line"."Cantidad master")+
                                    (Q_Inners*"Sales Shipment Line"."Cantidad inner")<>"Sales Shipment Line".Quantity then begin
                                    Resto_uni:="Sales Shipment Line".Quantity-((Q_Masters*"Sales Shipment Line"."Cantidad master")+
                                                   (Q_Inners*"Sales Shipment Line"."Cantidad inner"));
                                end;
                            end;
                        end;
                    end;
                    if (Resto_inner<"Sales Shipment Line"."Cantidad inner") then begin
                        Resto_uni:=Resto_inner;
                    end;
                    if ("Sales Shipment Line"."Cantidad inner"=1) then begin
                        Resto_uni:=Resto_inner;
                    end;
                ...
                Multitabla.SetRange(Producto,"Sales Shipment Line"."No.");
                ...
                textocajas:='';
                LineasAMAZON.Reset;
                LineasAMAZON.SetRange(LineasAMAZON.nexpe,"Sales Shipment Line"."Nº expedición");
                LineasAMAZON.SetRange(LineasAMAZON.your,"Sales Shipment Line"."Your Reference");
                LineasAMAZON.SetRange(prod,"Sales Shipment Line"."No.");
                if LineasAMAZON.FindFirst then repeat
    ...
    var
        ...
        textocajas: Text;
        Amazonmaster_inner: Record UnknownRecord50043;
}
