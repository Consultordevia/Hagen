...
Table 50042 "Clientes Item Unit of Measure"
{
    Caption = 'Unidad Amazon master_inner';
    ...
    fields
    {
        ...
        field(2; "Nombre Producto"; Text[100])
        {
            CalcFormula = lookup(Item.Description where("No." = field("Item No.")));
            FieldClass = FlowField;
        }
        field(3; "Cantidad master"; Decimal)
        {
        }
        field(4; "Cantidad inner"; Decimal)
        {
        }
    }
    ...
    fieldgroups
    {
        fieldgroup(DropDown; "Nombre Producto", "Cantidad master")
        {
        }
    }
