...
Table 50032 "Item Ledger Entry-COPIA"
{
    ...
    fields
    {
        ...
        {
            AutoFormatType = 1;
            //CalcFormula = sum("Value Entry-copia"."Cost Amount (Expected)" where ("Item Ledger Entry No."=field("Entry No.")));
        ...
        {
            AutoFormatType = 1;
            //CalcFormula = sum("Value Entry-copia"."Cost Amount (Actual)" where ("Item Ledger Entry No."=field("Entry No.")));
        ...
        {
            AutoFormatType = 1;
            //CalcFormula = sum("Value Entry-copia"."Cost Amount (Non-Invtbl.)" where ("Item Ledger Entry No."=field("Entry No.")));
        ...
        {
            AutoFormatType = 1;
            //CalcFormula = sum("Value Entry-copia"."Cost Amount (Expected) (ACY)" where ("Item Ledger Entry No."=field("Entry No.")));
        ...
        {
            AutoFormatType = 1;
            //CalcFormula = sum("Value Entry-copia"."Cost Amount (Actual) (ACY)" where ("Item Ledger Entry No."=field("Entry No.")));
        ...
        {
            AutoFormatType = 1;
            //CalcFormula = sum("Value Entry-copia"."Cost Amount (Non-Invtbl.)(ACY)" where ("Item Ledger Entry No."=field("Entry No.")));
        ...
        {
            AutoFormatType = 1;
            //CalcFormula = sum("Value Entry-copia"."Purchase Amount (Expected)" where ("Item Ledger Entry No."=field("Entry No.")));
        ...
        {
            AutoFormatType = 1;
            //CalcFormula = sum("Value Entry-copia"."Purchase Amount (Actual)" where ("Item Ledger Entry No."=field("Entry No.")));
        ...
        {
            AutoFormatType = 1;
            //CalcFormula = sum("Value Entry-copia"."Sales Amount (Expected)" where ("Item Ledger Entry No."=field("Entry No.")));
        ...
        {
            AutoFormatType = 1;
            //CalcFormula = sum("Value Entry-copia"."Sales Amount (Actual)" where ("Item Ledger Entry No."=field("Entry No.")));
        ...
        {
            //CalcFormula = exist("Value Entry-copia" where ("Item Ledger Entry No."=field("Entry No."),
