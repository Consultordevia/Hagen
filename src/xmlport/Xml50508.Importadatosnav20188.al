...
XmlPort 50508 "Importa datos nav2018-8"
{
    Caption = 'Importa datos nav2018-8';
    Direction = Import;
    FieldSeparator = ';';
    Format = VariableText;
    TextEncoding =  UTF16;
    ...
    begin
        ...
        if RecItem.get(d1) then begin
            ...
            RecItem.Level2 := D3;
            RecItem.Level3 := D4;
            RecItem.Etiquetas1 := D5;
            RecItem.Etiquetas2 := D6;
            RecItem.Etiquetas3 := D7;
            RecItem.Etiquetas4 := D8;
            RecItem.Etiquetas5 := D9;
            RecItem.Etiquetas6 := D10;
            RecItem.Gama := D11;
            RecItem.Modify;
