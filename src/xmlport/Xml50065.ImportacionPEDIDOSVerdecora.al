...
XmlPort 50065 "Importacion PEDIDOS Verdecora"
{
    ...
    begin
        ...
        if linea > 1 then begin
            if linea = 2 then begin
                clie := '';
                RecClie.Reset;
                RecClie.SetRange("Codigo cliente externo", D22);
            ...
            if D9 <> '' then begin
                if RecProd.Get(D9) then begin
                    ...
                    RecRefCruz.SetRange(RecRefCruz."Reference No.", D9);
