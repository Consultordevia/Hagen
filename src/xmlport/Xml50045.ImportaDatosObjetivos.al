...
XmlPort 50045 "Importa Datos Objetivos"
{
    ...
    begin
        ...
        if RecItem.Get(D1) then begin
            Evaluate(RecItem."Objetivo Anual", D2);
            Evaluate(RecItem.Temporalidad, D3);
            Evaluate(RecItem."Objetivo trimestre 1", D4);
            Evaluate(RecItem."Objetivo trimestre 2", D5);
            Evaluate(RecItem."Objetivo trimestre 3", D6);
            Evaluate(RecItem."Objetivo trimestre 4", D7);
            RecItem.Modify;
        end;
    end;
}
