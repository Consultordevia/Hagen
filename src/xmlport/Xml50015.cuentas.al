...
XmlPort 50015 cuentas
{
    ...
    begin
        ...
        Cuentasdeproveedores.Proveedor := codigo;
        Cuentasdeproveedores.Cuenta := DOS;
        Evaluate(LINEA, TRES);
        Cuentasdeproveedores.contador := LINEA;
        Cuentasdeproveedores.Insert;
    end;
}
