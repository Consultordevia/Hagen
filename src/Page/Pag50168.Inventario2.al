...
Page 50168 Inventario2
{
    ...
    begin
        ...
        */
        ...
        /////- HASTA:=GetRangemax(Rec."Date Filter");
        ...
        COSTEMEDIO:=0;
        if Rec."Net Change 2"<>0 then begin
             COSTEMEDIO:=VALORMEDIO/Rec."Net Change 2";
        end;
        ...
        if COSTEMEDIO=0 then begin
             ...
             if VALORMEDIO=0 then begin
                  VALORMEDIO:=COSTEMEDIO*Rec."Net Change 2";
             end;
        end;
        ...
        valor:=Rec."Unit Cost"*Rec."Net Change 2";
        valor:=Rec."Inventory 2"*COSTEMEDIO;
