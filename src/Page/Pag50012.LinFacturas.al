    ...
    layout
    {
        area(Content)
        {
            repeater(General)
            {
                ...
                field(Abonar; Rec.Abonar)
                {
                    ToolTip = 'Specifies the value of the Abonar field.', Comment = '%';
                }
                ...
                {
                    ToolTip = 'Specifies the value of the Cantidad a abonar field.', Comment = '%';
                }
                ...
                {
                    ToolTip = 'Specifies the value of the Fecha factura field.', Comment = '%';
                }
                ...
                field("VENDE CABECERA"; Rec."VENDE CABECERA")
                {
                    ToolTip = 'Specifies the value of the VENDE CABECERA field.', Comment = '%';
                }
