...
Page 50082 "Parrilas Analisis"
{
    ...
    begin
        ...
        Rec.Init;
        Rec."No." := 'A';
        Rec."Block Reason" := Format(HASTAFECHA[X]);
        Rec.Insert;
        Rec.Init;
        Rec."No." := 'A0';
        Rec."Block Reason" := CodAnalisis;
        Rec.Insert;
        Rec.Init;
        Rec."No." := 'A00';
        Rec."Block Reason" := '--------------';
        ...
        Rec.Init;
        Rec."No." := 'A01';
        Rec."Block Reason" := 'Ventas Brutas / Sales';
        ...
        Rec.Init;
        Rec."No." := 'A02';
        Rec."Block Reason" := 'Descuentos en factura / invoice discounts';
        Rec."Single-Level Material Cost" := 0;
        ...
        Rec.Init;
        Rec."No." := 'A03';
        Rec."Block Reason" := 'Venta neta / net sales';
        Rec."Single-Level Material Cost" := 0;
        ...
        if Item.FindSet then
            repeat
                CONTA := IncStr(CONTA);
                Rec.Init;
                Rec."No." := 'B' + Format(CONTA);
                Rec."Block Reason" := Item.Description + ' (' + Format(Item."No.") + ')';
                Clear(MATRIX_CellData);
                X := 0;
                repeat
                    X := X + 1;
        ...
        */
        ...
        Rec.Init;
        Rec."No." := 'C001';
        Rec."Block Reason" := 'Adj. Gross Profit';
        ...
        Rec.Init;
        Rec."No." := 'C003';
        Rec."Block Reason" := 'Coste transporte';
        ...
        Rec.Init;
        Rec."No." := 'C004';
        Rec."Block Reason" := '% Portes/Ventas';
    ...
    begin
        ...
        repeat
            ...
            if SalesInvoiceHeader.FindSet then
                repeat
                    ...
                    if Rec113.Findset then
                        repeat
                            V.Update(1, 'ventas:' + Rec113."Document No." + ' ' +
                            Rec113."No." + ' ' +
                            SalesInvoiceHeader."Sell-to Customer No." + ' ' + Format(SalesInvoiceHeader."Posting Date"));
            ...
            if SalesCrMemoHeader.FindSet then
                repeat
                    V.Update(1, 'Abonos:' + SalesCrMemoHeader."Sell-to Customer No." + ' ' + Format(SalesCrMemoHeader."Posting Date"));
                    Margen := 0;
                    COSTEFAC := 0;
                    margenlin := 0;
                    CUANTALIN := 0;
    ...
    begin
        ...
        repeat
            ...
            if SalesInvoiceHeader.FindSet then
                repeat
                    ///V.Update(1,'Ventas2:'+SalesInvoiceHeader."Sell-to Customer No."+' '+Format(SalesInvoiceHeader."Posting Date"));
                    Margen := 0;
                    COSTEFAC := 0;
                    margenlin := 0;
                    CUANTALIN := 0;
            ...
            if SalesCrMemoHeader.Findset then
                repeat
                    V.Update(1, 'Abonos2:' + SalesCrMemoHeader."Sell-to Customer No." + ' ' + Format(SalesCrMemoHeader."Posting Date"));
                    Margen := 0;
                    COSTEFAC := 0;
                    margenlin := 0;
                    CUANTALIN := 0;
    ...
    begin
        ...
        repeat
            ...
            if SalesShipmentHeader.Findset then
                repeat
                    V.Update(1, 'x' + format(x) + SalesShipmentHeader."Sell-to Customer No." + ' ' + Format(SalesShipmentHeader."Posting Date"));
