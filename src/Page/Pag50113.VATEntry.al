page 50113 "VAT Entry"
{
    ...
    layout
    {
        area(Content)
        {
            repeater(General)
            {
                field("% IVA importación"; Rec."% IVA importación")
                {
                    ToolTip = 'Specifies the value of the % IVA importación field.', Comment = '%';
                }
                ...
                field("Base IVA Aduanas"; Rec."Base IVA Aduanas")
                {
                    ToolTip = 'Specifies the value of the Base IVA Aduanas field.', Comment = '%';
                }
                ...
                field(DUA; Rec.DUA)
                {
                    ToolTip = 'Specifies the value of the DUA field.', Comment = '%';
                }
                ...
                {
                    ToolTip = 'Specifies the value of the Do Not Send To SII field.', Comment = '%';
                }
                ...
                field("EC %"; Rec."EC %")
                {
                    ToolTip = 'Specifies the EC percentage that was used in purchase or sales lines with this VAT identifier.';
                }
                ...
                field("Factura de Aduanas"; Rec."Factura de Aduanas")
                {
                    ToolTip = 'Specifies the value of the Factura de Aduanas field.', Comment = '%';
                }
                ...
                field("Generated Autodocument"; Rec."Generated Autodocument")
                {
                    ToolTip = 'Specifies the value of the Generated Autodocument field.', Comment = '%';
                }
                field("Grupo cliente"; Rec."Grupo cliente")
                {
                    ToolTip = 'Specifies the value of the Grupo cliente field.', Comment = '%';
                }
                field("Ignore In SII"; Rec."Ignore In SII")
                {
                    ToolTip = 'Specifies the value of the Ignore In SII field.', Comment = '%';
                }
                ...
                {
                    ToolTip = 'Specifies the value of the No Taxable Type field.', Comment = '%';
                }
                ...
                {
                    ToolTip = 'Specifies the value of the One Stop Shop Reporting field.', Comment = '%';
                }
                field("Posting Date"; Rec."Posting Date")
                {
                    ToolTip = 'Specifies the VAT entry''s posting date.';
                }
                field("Proveedor Importación"; Rec."Proveedor Importación")
                {
                    ToolTip = 'Specifies the value of the Proveedor Importación field.', Comment = '%';
                }
                ...
                field("Valor Viejo Grupo Contable Neg"; Rec."Valor Viejo Grupo Contable Neg")
                {
                    ToolTip = 'Specifies the value of the Valor Viejo Grupo Contable Neg field.', Comment = '%';
                }
            }
        }
    }
