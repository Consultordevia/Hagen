...
Codeunit 50064 "Importacion PEDIDOS carrefour"
{

    trigger OnRun()
    var
        FicherosHagen: Codeunit FicherosHagen;
        Tipo: option CARREFOUR;

    begin


        ADAIA.Reset();
        ADAIA.SetRange(texto, 'IMPORTACION CARREFOUR-CU-50064');
        ...
        /////                                   Xmlport.Import(Xmlport::"Importacion PEDIDOS carrefour", varInputStream);
    end;
