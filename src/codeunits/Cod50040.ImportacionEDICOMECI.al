...
Codeunit 50040 "Importacion EDICOM ECI"
{
    ...
    begin
        ...
        /*
                                ...
                                if (UpperCase(CopyStr(NombreFichero,1,1))='O') then begin
                                          FILE.Copy(nomfich,RUTACOPIA+recFicheros.Name);
                                          FILE.Erase(nomfich);
                                end;
                                if (recFicheros.Size=0) and  (UpperCase(CopyStr(NombreFichero,1,1))='C') then begin
                                          FILE.Copy(nomfich,RUTACOPIA+recFicheros.Name);
                                          FILE.Erase(nomfich);
                                end;
                                if (recFicheros.Size=0) and  (UpperCase(CopyStr(NombreFichero,1,1))='L') then begin
                                          FILE.Copy(nomfich,RUTACOPIA+recFicheros.Name);
                                          FILE.Erase(nomfich);                                      
                                end;
                                */
        ...
        ///                            if UpperCase(CopyStr(NombreFichero,1,1))='C' then begin
        ///                                      Xmlport.Import(Xmlport::"Importacion PEDIDOS ECI EDICOM",varInputStream);

        ///                            if UpperCase(CopyStr(NombreFichero,1,1))='L' then begin
        ///                                      Xmlport.Import(Xmlport::"Importacion PEDLIN ECI EDICOM",varInputStream);
    end;
