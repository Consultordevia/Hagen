...
Codeunit 50088 "Importacion Verdecora2"
{
    ...
    begin
        ...
        ADAIA.Reset();
        ADAIA.SetRange(texto, 'IMPORTACION VERDECORA-CU-50088');
        IF ADAIA.FindSet() THEN begin
            nomdir := ADAIA.Ruta;
            RUTACOPIA := ADAIA.Ruta + 'copia/';
        end;
        Commit;
        tipo := Tipo::VERDECORA2;


        FicherosHagen.LeerArchivosCarpeta(nomdir, RUTACOPIA, Tipo)


        /////                                        Xmlport.Import(Xmlport::"Importacion PEDIDOS Verdecora", varInputStream);
