...
Codeunit 50075 "Automaticos Catit estados NEW"
{
    ...
    begin
      ...
      'Closed At,';
        ...
        'Customer: State,' +
        'Customer: Tags,';
        TextoSalida4 := 'Customer: Accepts Marketing,' +
        'Billing: First Name,' +
        'Billing: Last Name,' +
        'Billing: Name,' +
        'Billing: Company,' +
        ...
        'Billing: Country,';
        TextoSalida5 := 'Billing: Country Code,' +
        'Shipping: First Name,' +
        'Shipping: Last Name,' +
        'Shipping: Name,' +
        'Shipping: Company,' +
        'Shipping: Phone,' +
        'Shipping: Address 1,';
        TextoSalida6 := 'Shipping: Address 2,' +
        'Shipping: Zip,' +
        'Shipping: City,' +
        'Shipping: Province,' +
       ...
       'Line: Requires Shipping,';
        ...
        TextoSalida10 := 'Transaction: Kind,' +
        ...
        TextoSalida6 + TextoSalida7 + TextoSalida8 + TextoSalida9 + TextoSalida10 + TextoSalida11);
