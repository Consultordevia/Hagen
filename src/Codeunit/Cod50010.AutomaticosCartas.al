    ...
    begin
        ...
        IF RecTransp.get(rec110."Shipping Agent Code") THEN begin
            IF RecTransp."Codigo Hagen" <> '' THEN begin
                TextoSalida4 := PADSTR(FORMAT(RecTransp."Codigo Hagen"), 20, ' ');
                OutStream.Writetext(TextoSalida4);
...
2.INTRO.
    ...
    begin
        ...
        if Rec110."Sell-to Phone No." <> '' then begin
            NTEL2 := Format(Rec110."Sell-to Phone No.");
        end;
        ...
        IF RecTransp.get(rec110."Shipping Agent Code") THEN begin
            IF RecTransp."Codigo Hagen" <> '' THEN begin
                TextoSalida7 := TextoSalida7 + PADSTR(FORMAT(RecTransp."Codigo Hagen"), 20, ' ');
            end;
        END;
...
*/
        ...
        IF RecTransp.get(rec110."Shipping Agent Code") THEN begin
            IF RecTransp."Codigo Hagen" <> '' THEN begin
                TextoSalida5 := TextoSalida5 + ';' + PADSTR(FORMAT(RecTransp."Codigo Hagen"), 20, ' ');
            end;
        END;
    ...
    begin
        ...
        IF RecTransp.get(rec110."Shipping Agent Code") THEN begin
            IF RecTransp."Codigo Hagen" <> '' THEN begin
                TextoSalida3 := TextoSalida3 + PADSTR(FORMAT(RecTransp."Codigo Hagen"), 20, ' ');
            end;
        END;
            ...
            repeat
                ...
                /*
                            ...
                            if SalesInvHeader2.FindFirst then begin
                                ...
                                txtSubject := 'HAGEN - envio email FACTURA Nº ' + Format(SalesInvHeader."No.")+' '+RecCust."Search Name" ;                 
                ...
                txtSubject := SenderName + ' ' + RecCust."Search Name" + ' - FACTURA Nº ' + Format(SalesInvHeader."No.");
    ...
    procedure ENVIAREMIALFACTURASCANARIAS(var Rec: Record "Sales Invoice Header")
    var
        SenderName: Text[250];
        SenderAddress: Text[250];
        Recipient: Text[250];
    ...
    begin
        ...
        if SalesHeader."Sell-to Phone No." <> '' then begin
            NTEL2 := Format(SalesHeader."Sell-to Phone No.");
        end;
        ...
        IF RecTransp.get(rec110."Shipping Agent Code") THEN begin
            IF RecTransp."Codigo Hagen" <> '' THEN begin
                TextoSalida4 := TextoSalida4 + PADSTR(FORMAT(RecTransp."Codigo Hagen"), 20, ' ');
            end;
        END;
    ...
    procedure BCEnviarEmailSinC(parDestinatarios: List of [Text]; parSubject: Text; parBody: Text; parHtmlFormatted: Boolean; parPath: Text;
       parAttachmentName: Text[250]; parContentType: Text[250]; parEmailScenario: Enum "Email Scenario"; parCC: Text;
                                                                                      parBCC: Text;
...
Format('EXTRA_20');///86
        ...
        */
        ...
        IF REC110.Tipopalet1 <> '' THEN BEGIN
            ...
            OutTxt := OutTxt + Format(NTEL2) + Format(';') + Format(TEMAIL) + Format(';') + Format('DDP;') + Format(Rec110."Ship-to County", 30) + Format(';') + Format('1;') + Format('Palet;') + format(elpeso) + Format(';') + Format(eslargo) + ';' + Format(esancho) + ';' + Format(esalto) + ';' + Format(';') + Format('Producto para Mascotas;') + Format(rec110."Your Reference") + ';NO;' + Format(';');/// + Format(';');
            OutTxt := OutTxt + Format(Rec110."Nº expedición") + ';' + Format(';') + Format(';') + Format(';') + Format(';') + Format(';') + Format(';') + Format(';') + Format(';') + Format(';') + Format(';') + Format(';') + Format(';') + Format(';');
